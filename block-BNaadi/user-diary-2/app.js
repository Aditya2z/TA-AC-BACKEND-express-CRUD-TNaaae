...
mongoose
  .connect("mongodb://127.0.0.1/user-diary-2")
  .then(() => {
    console.log("Connected Successfully to user-diary-2 database");
  })
  .catch((err) => {
    console.log("Error connecting to user-diary-2 database");
});
