...
mongoose
  .connect("mongodb://127.0.0.1/user-diary-3")
  .then(() => {
    console.log("Connected Successfully to user-diary-3 database");
  })
  .catch((err) => {
    console.log("Error connecting to user-diary-3 database");
});
